...
export function CTAButton({
  ...
  return (
    <Link
      href={href}
      className={cn(
        "inline-flex min-h-12 items-center justify-center rounded-full px-5 py-3 text-sm font-semibold uppercase tracking-[0.12em] transition duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--color-red)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--color-cream)]",
        variant === "primary" &&
